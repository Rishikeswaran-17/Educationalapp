...
function CourseInformation() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("/insertorupdatecourseschedule", {
      method: "POST",
      body: formData,
    })
      .then((response) => {
  ...
  useEffect(() => {
    ...
    console.log("dateRangefrom:", dateRangefrom);
    console.log("dateRangeto:", dateRangeto);
  }, [subcourseName, employeeID, count, learnerCount, classTimingsFrom, classTimingsTo, dateRangefrom, dateRangeto]);
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      {matchingcoursecontent && (
        <div>
          ...
          <div className="flex m-3 gap-3">
            ...
            <div
              key="Trainer"
              className="bg-slate-300 my-1 h-48 dark:text-gray-200 dark:bg-secondary-dark-bg lg:w-64 lg:ml-3 md:w-56 p-4 pt-9 rounded-2xl"
            >
              ...
              <p className="mt-2">
                <span className="text-lg font-semibold">Kaali</span>
            ...
            >
              ...
              <p className="mt-2 flex gap-5">
                <span className="text-rose-600 text-6xl">{count}</span>
      ...
      <div className="w-400 bg-slate-300 dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
