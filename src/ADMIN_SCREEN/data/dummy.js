...
export const gridOrderStatus = (props) => (
  <button
    ...
    className="bg-green-400 py-1 px-2 capitalize rounded-2xl text-md"
  >
    {props.Status}
  </button>
);
...
export const customersGrid = [
  { type: 'checkbox', width: '50' },
  {
    ...
    width: '120',
    textAlign: 'Left',
    template: (data) => <a href={`/students-information/${data.LearnerID}`}>{data.LearnerID}</a>,
  },
  {
    field: 'Name',
    headerText: 'Name',
...
export const coursesPurchasedData = [
  {
    icon: <BsBoxSeam />,
    coursesPurchased: '2',
    percentage: '+23%',
...
export const sessionModeData = [
  {
    ...
    time1: '10:30AM - 12:30PM',
    time2: '12:30PM - 2:30PM',
    course1: 'CCC',
    course2: 'BVC',
...
export const classModeData = [
  {
    icon: <HiOutlineRefresh />,
    time1: 'Weekends/Weekdays',
    time2: 'LiveClass/Self-Paced',
    course1: 'CCC',
    course2: 'BVC',
    title: 'Class Modes',
    iconColor: 'rgb(0, 194, 146)',
...
export const ordersGrid = [
  ...
  {
    field: 'enrolledcustomers',
    headerText: 'No of Learners',
    editType: 'numericedit',
    width: '150',
    textAlign: 'Center',
  },
...
export const customersData = [
  {
    StudentID: 100011,
    Batch: '2023-24',
    BatchTiming: '8:30am to 10:30pm',
    Name: 'Nirav',
    age: 26,
    grade: 'A+',
    CourseEnrolled: 'CCC, BVC, P&F, PMM',
...
export const employeesData = ({ EmployeeID, Name, Designation, Courses, HiredDate, ReportsTo, Status, PhoneNumber, Location, image , Payslip, Monthlysalary }) => ({
  Employeeimage: image,
...
export const ordersData = ({ subcourseid, image, subcoursename, enrolledcustomers, Status, Trainer, Courseamount }) => ({
  ProductImage: image,
  Courses: subcoursename,
  Trainer: Trainer,
  Courseamount: Courseamount,
  Status: Status,
  CourseID: subcourseid,
  NumberofLearners: enrolledcustomers,
  StatusBg: '#FB9678', // Set the background color based on the status
});
