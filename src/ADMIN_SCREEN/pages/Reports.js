...
import { earningData, medicalproBranding, recentTransactions,  weeklyStats, dropdownData, SparklineAreaData, ecomPieChartData, classModeData, sessionModeData, progressData, coursesPurchasedData, } from '../data/dummy';
...
const Reports = () => {
  ...
  return (
    <div className='my-3 absolute top-12 left-96 w-9/12'>
      <div className="flex flex-wrap lg:flex-nowrap justify-center bg-slate-200 dark:bg-main-bg">
        ...
        <div className="flex my-3 flex-wrap justify-center gap-3 items-center">
          {earningData.map((item) => (
            <div
              key={item.title}
              className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg lg:w-64 md:w-56 p-4 pt-9 rounded-2xl "
            >
              <button
                type="button"
          ...
          {progressData.map((progress) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400 mt-1">{progress.title}</p>
            </div>
          ))}
          ...
          {classModeData.map((time) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400  mt-1">{time.title}</p>
            </div>
          ))}
        </div>
      </div>

      <div className="flex gap-10 flex-wrap justify-center bg-slate-200 dark:bg-main-bg">
      ...
      <div className="flex flex-wrap justify-center bg-slate-200 dark:bg-main-bg">
