  ...
  return (
    <div className="bg-slate-200 dark:bg-main-dark-bg h-screen">
      <div className=" w-96 sm:w-3/5 lg:w-2/6 rounded-lg shadow-md bg-white dark:bg-secondary-dark-bg mx-auto relative top-20 p-4">
        ...
        <div className="middle p-3 dark:text-white">
          ...
          <div className="mt-3 flex justify-between">
            ...
            <Link to="/signup">
              <button
                className="rounded-lg py-3 px-5 font-sans text-sm font-medium text-orange-600 hover:text-orange-600 transition-all hover:bg-orange-100 active:bg-orange-600 disabled:pointer-events-none disabled:shadow-none flex justify-evenly"
