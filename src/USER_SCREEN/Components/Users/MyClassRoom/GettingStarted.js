...
const GettingStarted = () => {
     return (
          <Container classname='gettingstarted' maxWidth="md" sx={{
               display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '10vh', marginTop: '-35%', marginRight: '910px',
                    ...
                    <CardContent>
                         ...
                         <section className="gettingstrtedmain">
                              ...
                              <p className="introtxt">
                                   Before embarking on your learning journey with edureka, let us walk you through few important features of our LMS, which will guide you towards the optimum path of course completion.
                              </p>
