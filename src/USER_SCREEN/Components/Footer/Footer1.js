...
const Footer1 = () => {
  return (
    <div className="bg-blue-950 w-full bottom-0">
      <div className="w-11/12 mx-auto p-10">
        <div className="">
          <img
            ...
            title="logo"
            loading="lazy"
            src="https://d1jnx9ba8s6j9r.cloudfront.net/img/Edureka_V_W_logo.webp"
          />
        </div>
        <div class="grid grid-cols-3 gap-4 mt-10 text-white">
          ...
          <div>
            ...
            <div className="mt-3">
              <img
                ...
                title="App Store"
                loading="lazy"
                src="https://d1jnx9ba8s6j9r.cloudfront.net/img/ios.svg"
              />
            </div>
            <div className="mt-3">
              <img
                ...
                title="Play Store"
                loading="lazy"
                src="https://d1jnx9ba8s6j9r.cloudfront.net/img/android.svg"
              />
            </div>
          </div>
        </div>
